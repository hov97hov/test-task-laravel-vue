    ...
    data: () => {
        return {
            ...
            headers: [
                ...
                { text: 'Էլ․ փոստ', sortable: false, value: 'calories' },
                { text: 'Հեռախոս', sortable: false, value: 'fat' },
                { text: 'Խումբ', sortable: false, value: 'carbs' },
                { text: 'Գրանցման ամսաթիվ', sortable: false, value: 'protein' },
